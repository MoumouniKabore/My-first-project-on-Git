...
button = Button(middle_frame, text="Calcul", width=20, font=("aptos", 10), relief="raised", background="silver", fg="black")
...
# Category Frame
label_back = Label(category_frame, text='(empty)', height=5, width=40, font=("aptos", 9), relief="flat", background="white", fg="black")
